...
public class ExLeInterface extends JFrame {
	...
	public ExLeInterface(File ontology) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				System.out.println("T tbox: ");
				int i = 1;
				for(OWLAxiom ax : axiomsT) {
					System.out.println("CI #" + i + ": " + myRenderer.render(ax));
					i++;
				}
			}
		});
		...
		btnNewButton_1 = new JButton("h");
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				System.out.println("H tbox: ");
				int i = 1;
		...
		btnNewButton_1.setBounds(142, 260, 89, 23);
